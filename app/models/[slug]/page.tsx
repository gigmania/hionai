...
import { getModelBySlug } from "@/lib/live-data";
        ...
        <div className="mx-auto grid w-[min(980px,calc(100%-32px))] gap-8">
          ...
          <section className="rounded-lg border border-line bg-white p-8">
            ...
            {model.lastVerifiedAt ? (
              <p className="mb-6 font-mono text-xs font-black uppercase tracking-wide text-muted">
                Verified {new Date(model.lastVerifiedAt).toLocaleDateString()}
              </p>
            ) : null}
